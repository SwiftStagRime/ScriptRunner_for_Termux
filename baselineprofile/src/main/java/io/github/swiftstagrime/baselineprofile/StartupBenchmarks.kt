    ...
    private fun benchmark(compilationMode: CompilationMode) {
        ...
        rule.measureRepeated(
            ...
            measureBlock = {
                ...
                val onboardingBtn = By.res(targetPackage, "onboarding_complete_button")
                val fab = By.res(targetPackage, "fab_add_script")

                device.wait(Until.hasObject(onboardingBtn), 5_000) ||
                        device.wait(Until.hasObject(fab), 5_000)
            }
        )
    }
}
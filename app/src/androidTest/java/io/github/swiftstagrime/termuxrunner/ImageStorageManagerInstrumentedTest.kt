...
class ImageStorageManagerInstrumentedTest {
    ...
    @Test
    fun saveImageFromUri_smallBitmap_noScaling() = runTest {
    ...
    @Test
    fun saveImageFromUri_largeBitmap_scalesToTargetSize() = runTest {
    ...
    @Test
    fun saveImageFromUri_squareBitmap_scalesEvenly() = runTest {
    ...
    @Test
    fun saveImageFromUri_tallBitmap_preservesAspectRatio() = runTest {
    ...
    @Test
    fun saveImageFromUri_producesUniqueFilenames() = runTest {
    ...
    @Test
    fun saveImageFromUri_createsIconDirectoryIfNeeded() = runTest {
    ...
    @Test
    fun saveImageFromUri_invalidUri_returnsFailure() = runTest {
    ...
    @Test
    fun saveImageFromUri_exactTargetSize_noScaling() = runTest {
    ...
    @Test
    fun saveImageFromUri_oneOverTarget_otherUnder_noScalingOnSmallDimension() = runTest {

...
class BackupImportExportTest {
    ...
    @Test
    fun importV1_legacyFormat_rawArray_importsScriptsCorrectly() =
        runTest {
            val v1Json =
                """
                [
    ...
    @Test
    fun importV1_format_migratesLegacyCodeFieldToCodePages() =
        runTest {
            val v1Json =
                """
                [
    ...
    @Test
    fun importV2_format_withScriptsOnly_importsCorrectly() =
        runTest {
            val v2Json =
                """
                {
    ...
    @Test
    fun importV2_format_withExplicitVersionField() =
        runTest {
            val v2Json =
                """
                {
    ...
    @Test
    fun importV3_format_withCategoriesScriptsAndAutomations() =
        runTest {
            val v3Json =
                """
                {
    ...
    @Test
    fun importV3_format_skipsThemesFieldSinceAbsent() =
        runTest {
            val v3Json =
                """
                {
    ...
    @Test
    fun importV4_format_withAdvancedScriptFields() =
        runTest {
            val v4Json =
                """
                {
            ...
            assertEquals(1, script.notifyOnResult)
            ...
            assertEquals(ForegroundSessionBehavior.SWITCH_OPEN, script.foregroundSessionBehavior)
            assertTrue(script.reuseSession)
    ...
    @Test
    fun importV5_format_withCustomThemes() =
        runTest {
            val v5Json =
                """
                {
    ...
    @Test
    fun roundtrip_exportAndImport_preservesAllData() =
        runTest {
            val catId1 =
                categoryDao.insertCategory(CategoryEntity(name = "Network", orderIndex = 0)).toInt()
            val catId2 =
                categoryDao.insertCategory(CategoryEntity(name = "Storage", orderIndex = 1)).toInt()
    ...
    @Test
    fun import_deduplicatesCategoriesByName() =
        runTest {
            val existingCatId =
                categoryDao
                    .insertCategory(CategoryEntity(name = "Existing", orderIndex = 5))
                    .toInt()
    ...
    @Test
    fun import_remapsAutomationScriptIdsToNewlyInsertedScripts() =
        runTest {
    ...
    @Test
    fun import_skipsThemesWithDuplicateNames() =
        runTest {
            customThemeDao.insertTheme(
                CustomThemeEntity(
                    name = "ExistingTheme",
                    ...
                    onPrimary = 0L,
                    primaryContainer = 0L,
                    onPrimaryContainer = -1L,
                    secondary = -2L,
                    onSecondary = 1L,
                    secondaryContainer = 2L,
                    onSecondaryContainer = 3L,
                    tertiary = 4L,
                    onTertiary = 5L,
                    tertiaryContainer = 6L,
                    onTertiaryContainer = 7L,
                    error = 8L,
                    onError = 9L,
                    errorContainer = 10L,
                    onErrorContainer = 11L,
                    background = 12L,
                    onBackground = 13L,
                    surface = 14L,
                    onSurface = 15L,
                    surfaceVariant = 16L,
                    onSurfaceVariant = 17L,
                    outline = 18L,
                    outlineVariant = 19L,
                    surfaceContainer = 20L,
                    surfaceContainerLowest = 21L,
                ),
            )
    ...
    @Test
    fun import_savesBase64IconAndRoundtripsCorrectly() =
        runTest {
    ...
    @Test
    fun import_malformedJson_returnsFailure() =
        runTest {
    ...
    @Test
    fun import_emptyFile_returnsFailure() =
        runTest {
    ...
    @Test
    fun export_producesValidV5JsonWithAllTopLevelFields() =
        runTest {
            scriptDao.insertScript(
                ScriptEntity(
                    name = "ExportTest",
            ...
            assertEquals(
                ...
                dto.scripts[0].foregroundSessionBehavior,
            )
            assertFalse(dto.scripts[0].reuseSession)

            exportFile.delete()
        }

    @Test
    fun export_withEmptyDatabase_producesValidMinimalBackup() =
        runTest {
    ...
    @Test
    fun import_handlesAllAutomationTypes() =
        runTest {
    ...
    @Test
    fun import_preservesCodePagesAndPageNames() =
        runTest {
            val jsonWithPages =
                """
                {
    ...
    @Test
    fun import_generatesPageNamesWhenNotProvided() =
        runTest {

...
class AutomationTimeCalculatorTest {
    ...
    fun `periodic handles very small interval without hanging`() {
        ...
        val result =
            AutomationTimeCalculator.calculateNextRun(entity, fromTime = 1_000_001_000_000L)
